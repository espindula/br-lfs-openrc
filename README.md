...
# AVISO: este repositório contém uma versão não oficial e não testada (pela Equipe de Desenvolvimento oficial) do livro Linux From Scratch, usando o OpenRC como inicializador do sistema. Os arquivos disponibilizados aqui foram obtidos a partir do repositório do Zeckma (ramificação ``openrc'' no endereço <https://git.linuxfromscratch.org/lfs.git>).
